...
class RestCatalogTransport implements CatalogTransport {
  private final NessieCatalogService service;

  RestCatalogTransport(NessieCatalogService service) {
  ...
  public String transportName() {
    return RestCatalogTransportFactory.NAME;
  }
