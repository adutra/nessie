...
class GrpcCatalogTransport implements CatalogTransport {
  private final NessieCatalogServiceStub catalogService;

  GrpcCatalogTransport(NessieCatalogServiceStub catalogService) {
  ...
  public String transportName() {
    return GrpcCatalogTransportFactory.NAME;
  }
