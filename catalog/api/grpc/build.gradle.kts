...
extra["maven.name"] = "Nessie - Catalog - gRPC API"

description = "Nessie Catalog API implementation to a remote gRPC Nessie Catalog service."

dependencies {
  implementation(project(":nessie-catalog-schema-model"))
  implementation(project(":nessie-catalog-api-base"))
  implementation(project(":nessie-catalog-api-proto"))
