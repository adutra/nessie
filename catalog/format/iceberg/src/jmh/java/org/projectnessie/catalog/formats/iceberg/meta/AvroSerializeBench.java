...
public class AvroSerializeBench {
  ...
  public void deserializeIcebergManifestFile(BenchmarkParam param, Blackhole blackhole)
      throws Exception {
    try (IcebergManifestFileReader.IcebergManifestFileEntryReader reader =
        IcebergManifestFileReader.builder()
            .build()
            .entryReader(new SeekableByteArrayInput(param.serializedIcebergManifestFile))) {
  ...
  public void deserializeIcebergManifestList(BenchmarkParam param, Blackhole blackhole)
      throws Exception {
    try (IcebergManifestListReader.IcebergManifestListEntryReader reader =
        IcebergManifestListReader.builder()
            .build()
            .entryReader(new SeekableByteArrayInput(param.serializedIcebergManifestList))) {
      reader.forEachRemaining(blackhole::consume);
    }
  }
