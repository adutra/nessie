...
public abstract class IcebergManifestListReader {
  ...
  public static Builder builder() {
    return ImmutableIcebergManifestListReader.builder();
  }
  ...
  public interface Builder {
    ...
    IcebergManifestListReader build();
  }

  @Value.Lazy
  public IcebergManifestListEntryReader entryReader(SeekableInput input) {
    try {
  ...
  public interface IcebergManifestListEntryReader
      extends AutoCloseable, Iterator<IcebergManifestFile> {
    IcebergSpec spec();
  ...
  private static final class ManifestListReaderImplList implements IcebergManifestListEntryReader {
