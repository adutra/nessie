...
public abstract class IcebergManifestFileReader {
  ...
  public static Builder builder() {
    return ImmutableIcebergManifestFileReader.builder();
  }
  ...
  public interface Builder {
    ...
    IcebergManifestFileReader build();
  }

  @Value.Lazy
  public IcebergManifestFileEntryReader entryReader(SeekableInput input) {
  ...
  public interface IcebergManifestFileEntryReader
      extends AutoCloseable, Iterator<IcebergManifestEntry> {
    IcebergSpec spec();
  ...
  private static final class ManifestFileEntryReaderImpl implements IcebergManifestFileEntryReader {
