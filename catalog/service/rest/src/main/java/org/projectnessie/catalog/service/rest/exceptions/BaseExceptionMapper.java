 ...
 */
package org.projectnessie.catalog.service.rest.exceptions;
...
public abstract class BaseExceptionMapper<T extends Throwable> implements ExceptionMapper<T> {
  ...
  private final CatalogServerConfig serverConfig;

  @Context private HttpHeaders headers;

  protected BaseExceptionMapper(CatalogServerConfig serverConfig) {
