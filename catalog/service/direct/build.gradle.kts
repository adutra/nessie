...
extra["maven.name"] = "Nessie - Catalog - Direct Service"

description = "Nessie Catalog service implementation for direct, in-JVM access."

dependencies {
  implementation(project(":nessie-catalog-api-base"))
  implementation(project(":nessie-catalog-api-direct"))
